...
public class EchoMiddleware : ITcpMiddleware
{
    ...
    {
        Console.WriteLine($"tcp {DateTime.Now} {connection.LocalEndPoint.ToString()} request size: {source.Length}");
    ...
    {
        Console.WriteLine($"tcp {DateTime.Now} {connection.SelectedDestination.EndPoint.ToString()} reponse size: {source.Length}");
